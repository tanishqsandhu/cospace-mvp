  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow p-8">
        ...
        <p className="text-gray-500 text-center text-sm mb-8">Enter your details to access your account</p>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            ...
            <div className="text-right mt-1">
              <Link href="/auth/forgot" className="text-xs text-indigo-600 font-medium hover:underline">Forgot password?</Link>
            </div>
          </div>
